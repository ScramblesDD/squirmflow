...
function Rig() {
    ...
    return useFrame(() => {
        camera.position.lerp(vec.set(pointer.x, pointer.y, camera.position.z), .05)
        camera.lookAt(0, 0, 0)
    })
}
const iconData = [
...
const IconOverlay = () => {
    ...
    const getIconPosition = (index) => {
        ...
        const edgeIconOffset = dimensions.height < 600 ? dimensions.height * 0.05 : 30 * scale;
    ...
    return (
        <div ref={containerRef}>
            <div className="relative w-full h-full pointer-events-none">
                ...
                {hoveredIndex !== null && (
                    <div className="absolute top-6 left-6 bg-black/20 backdrop-blur-md rounded-xl p-4 shadow-lg
                    pointer-events-none">
        ...
        <section className={"section-bg"}>
            <div className={"BgContainer"}>
                <div className={"w-full h-full relative inset-0 p-6"}>
                    ...
                    <Canvas className={"w-full h-full rounded-[50px]"}
                            shadows
                        ...
                        <Wormpile  position={[0, -.75, 0]} rotation={[0, 1.4, 0]} />
