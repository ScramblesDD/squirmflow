        ...
        <group {...props}
            ...
            <mesh name="three"
                geometry={nodes.three.geometry}
                  onClick={() => setActiveModal("three")}
            >
                <meshStandardMaterial color={hoveredPart === 'three' ? 'black' : 'white'}
                    roughness={0.33} metalness={1} envMapIntensity={2} />
            </mesh>
            ...
            <mesh name="rive"
                geometry={nodes.rive.geometry}
                  onClick={() => setActiveModal("rive")}
                >
                <meshStandardMaterial color={hoveredPart === 'rive' ? 'white' : 'black'} envMapIntensity={2}/>
            </mesh>

            <mesh name ='blender_eyelash'
                geometry={nodes.Curve002_1.geometry}
                  onClick={() => setActiveModal("blender")}
                >
            ...
            >
                <meshStandardMaterial
                    color={hoveredPart === 'blender_eyelash' ? '#905b00' : hoveredPart === 'blender_pupil' ? '#905b00' :
                        hoveredPart === 'blender_sclera' ? '#905b00' : '#6fa4ff'} envMapIntensity={2}/>
            </mesh>
            ...
            <mesh name = 'blender_sclera'
                geometry={nodes.Curve002_2.geometry}
                  onClick={() => setActiveModal("blender")}
            >
                <meshStandardMaterial color={hoveredPart === 'blender_sclera' ? 'black' : hoveredPart ===
                'blender_pupil' ? 'black' : hoveredPart === 'blender_eyelash' ? 'black' : 'white'} envMapIntensity={2}/>
            </mesh>

            <mesh name='react_atom'
                geometry={nodes.Curve006.geometry}
                  onClick={() => setActiveModal("react")}
            >
